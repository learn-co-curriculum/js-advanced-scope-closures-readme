...
Let's pay careful attention to what happened in the above code. We declared a
...
So just like we can return a function called `retailPriceForNine` and then see
